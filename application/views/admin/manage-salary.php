                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo date('M d, Y', strtotime($cnt['added_on'])); ?></td>
                        <td class="td-data">
                        <a data-toggle="tooltip" title="Reciept" style="color: green;" class="td-a" href="<?php echo base_url(); ?>print-reciept/<?php echo $cnt['id']; ?>" ><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-receipt" viewBox="0 0 16 16">
                        ...
                        <a data-toggle="tooltip" title="Invoice" style="color: blue;" class="td-a" class="btn btn-danger " href="<?php echo base_url(); ?>salary-invoice/<?php echo $cnt['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-newspaper" viewBox="0 0 16 16">
...
if (answer) {
            location.href="<?php echo base_url(); ?>delete-salary/"+id;
