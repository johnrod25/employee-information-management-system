...
$route['delete-staff/(:num)'] = 'staff/delete_all/$1';
$route['edits-staff/(:num)'] = 'staff/tryEdit/$1';
$route['edit-staff/(:num)'] = 'staff/edit/$1';
$route['update-staff'] = 'staff/update';
$route['info-form/(:num)'] = 'staff/infoForm/$1';
...
$route['print-reciept/(:num)'] = 'salary/printReciept/$1';
