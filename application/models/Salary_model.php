...
class Salary_model extends CI_Model {
    ...
    function select_salary()
    {
        ...
        $this->db->select("salary_tbl.*,staff_tbl.firstname, staff_tbl.lastname, staff_tbl.midname,staff_tbl.suffix,staff_tbl.pic,department_tbl.department_name");
    ...
    function select_salary_byID($id)
    {
        ...
        $this->db->select("salary_tbl.*,staff_tbl.*,department_tbl.department_name,position_tbl.position_name");
        $this->db->from("salary_tbl");
        $this->db->join("staff_tbl",'staff_tbl.id=salary_tbl.staff_id');
        $this->db->join("department_tbl",'department_tbl.id=staff_tbl.department_id');
    ...
    function select_salary_byStaffID($staffid)
    {
        ...
        $this->db->select("salary_tbl.*,staff_tbl.firstname, staff_tbl.lastname, staff_tbl.midname,staff_tbl.suffix,staff_tbl.city,staff_tbl.state,staff_tbl.mobile,staff_tbl.email,department_tbl.department_name");
        $this->db->from("salary_tbl");
        $this->db->join("staff_tbl",'staff_tbl.id=salary_tbl.staff_id');
        $this->db->join("department_tbl",'department_tbl.id=staff_tbl.department_id');
        $qry=$this->db->get();
